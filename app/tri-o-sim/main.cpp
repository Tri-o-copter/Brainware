...
#undef main // fixes linking error for compilation without SDL2main
//http://forums.libsdl.org/viewtopic.php?t=10789&sid=e8720b56929ac09f667a50a7e2ffc9e3

#include "c_joystick_manager.hpp"

#include "c_flightgear_sender_asio.hpp"
c_flightgear_sender_asio FGM("127.0.0.1", 5507);
...
int main(int argc, char **argv )
{
    ...
    if(joystick.isJoystickAvailable())
    {
